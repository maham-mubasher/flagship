        ...
        <div class="row mb-5">
            <div class="col-md-6">
                <x-card>
                    ...
                    <x-slot name="tool">
                        <button type="button" class="ms-3 btn btn-light btn-sm swap-address" data-bs-target="shipper_swap_address" data-prefix="shipper" data-bs-toggle="modal">Swap Address</button>
                        ...
                        <button type="button" class="ms-3 btn btn-light btn-sm clear-fields" data-bs-target="#clear_all1" data-prefix="shipper" data-bs-toggle="modal">Clear</button>
                    </x-slot>
                    <div class="row mb-3">
                    ...
                    <input type="hidden" name="is_qoute" value="1">
            ...
            <div class="col-md-6">
                <x-card>
                    ...
                    <x-slot name="tool">
                        <button type="button" class="ms-3 btn btn-light btn-sm swap-address" data-bs-target="receiver_swap_address" data-prefix="receiver" data-bs-toggle="modal">Swap Address</button>
                        ...
                        <button type="button" class="ms-3 btn btn-light btn-sm clear-fields" data-bs-target="#clear_all2" data-prefix="receiver" data-bs-toggle="modal">Clear</button>
                    </x-slot>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9 col-12">
                            <input type="text" id="receiver_address" autocomplete="off" name="receiver[address]" required="required" maxlength="30" placeholder="eg. 148 Brunswick Blvd" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9 col-12">
                            <input type="text" id="receiver_postal_code" autocomplete="off" name="receiver[postal_code]" required="required" placeholder="eg. H9R 5P9" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9 col-12">
                            <input type="text" id="receiver_city" autocomplete="off" name="receiver[city]" required="required" placeholder="eg. Montreal" class="form-control">
                        </div>
                    </div>
            ...
            <div class="col-md-5">
                <x-card>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9 col-12">
                            <div class="input-group" autocomplete="off" id="shipment_date" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                <input id="shipment_date_input" type="text" name="shipment[shipment_date]" required="required" maxlength="30" value="{{ old('shipment_date') }}" class="form-control" data-td-target="#shipment_date"/>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9 col-12">
                            <input type="text" autocomplete="off" id="options_reference" name="shipment[reference]" placeholder="" class="form-control"  value="">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9 col-12">
                            <input type="text" id="options_driver_instructions" name="shipment[driver_instructions]" autocomplete="off" placeholder="" class="form-control"  value="">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-3 col-12">
                    ...
                    <div id="cod_check" style="background: white !important; padding: 2%; margin-bottom: 2%" class="d-none">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3 col-12">
                                <label class="form-label required" for="receiver_phone">receiver Phone</label>
                            </div>
                            <div class="col-md-9 col-12">
                                <input type="text" id="receiver_phone"  autocomplete="off" name="cod[receiver_phone]" placeholder="Receiver Phone" class="form-control">
                            </div>
                        </div>
                    ...
                    <div id="third_party_div" class="d-none">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9 col-12">
                                <input type="text" id="company_name"  autocomplete="off" name="third_party[company_name]" maxlength="30" placeholder="Company / Sender's Name" class="form-control" value="{{ old('company_name') }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-3 col-12">
                                <label class="form-label required" for="attention">Attention</label>
                            </div>

                            <div class="col-md-9 col-12">
                                <input type="text" id="attention"  autocomplete="off" name="third_party[attention]" maxlength="30" placeholder="Sender's Name" class="form-control"  value="{{ old('attention') }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9 col-12">
                                <input type="text" id="third_address"  autocomplete="off" name="third_party[address]" maxlength="30" placeholder="eg. 148 Brunswick Blvd" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9 col-12">
                                <input type="text" id="third_suite" autocomplete="off" name="third_party[suite]" maxlength="30" placeholder="eg. 101" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-3 col-12">
                            ...
                            <div class="col-md-9 col-12">
                                <input type="text" id="third_suite" autocomplete="off" name="third_party[department]" maxlength="30" placeholder="eg. 101" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9 col-12">
                                <input type="text" id="third_postal_code" autocomplete="off" name="third_party[postal_code]" placeholder="eg. H9R 5P9" class="form-control">
                            </div>
                        </div>

                        <div class="row mb-3">
                            <div class="col-md-3 col-12">
                                <label class="form-label required" for="third_city">City</label>
                            </div>

                            <div class="col-md-9 col-12">
                                <input type="text" id="third_city" autocomplete="off" name="third_party[city]" placeholder="eg. Montreal" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-3 col-12">
                                <label class="form-label" for="third_province">Province</label>
                            </div>

                            <div class="col-md-9 col-12">
                                <select name="third_party[province_id]" id="third_province" class="form-select select_class" data-control="select2">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3 col-12">
                                <label class="form-label required" for="third_email">Tracking Emails</label>
                            </div>

                            <div class="col-md-9 col-12">
                                <input type="text" id="third_email"  autocomplete="off" name="third_party[tracking_email]" placeholder="example@domain.com" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
        ...
        <div class="row">
            <div class="col-md-12 text-end">
                ...
                <button type="submit" id="kt_sign_in_submit" class="btn btn-primary">
                    ...
                    <span class="indicator-label"><i class="fa fa-paper-plane"></i> Next</span>
                    <!--end::Indicator label-->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-10">
                                ...
                                <select name="address_group_id" id="address_group_id" class="form-select" data-control="select2" data-hide-search="true" disabled>
    ...
    <script type="text/javascript"
         ...
         <script>
            ...
            function initialize() {
                ...
                var check_auto_correct = document.getElementById('receiver_address_correction');
