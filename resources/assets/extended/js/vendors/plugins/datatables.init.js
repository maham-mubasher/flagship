...
var defaults = {
    ...
    "initComplete": function (settings, json) {
        $(this).closest('.dataTables_wrapper').find('.dataTables_filter input').addClass('form-control w-250px').removeClass('form-control-sm');
    ...
    "headerCallback": function (thead, data, start, end, display) {
        $(thead).find('th').addClass('text-start fw-bolder fs-7 text-uppercase gs-0');
    },
};
