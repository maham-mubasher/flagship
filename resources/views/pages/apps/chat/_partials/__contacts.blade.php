...
<div class="card card-flush">
    ...
    <div class="card-header pt-7" id="kt_chat_contacts_header">
        ...
        <form class="w-100 position-relative" autocomplete="off">
            <!--begin::Icon-->
            {!! theme()->getIcon("magnifier", "fs-2 fs-lg-1 text-gray500 position-absolute top-50 ms-5 translate-middle-y") !!}
            <!--end::Icon-->
        ...
        <div
            ...
            @for($i = 1; $i <= $total; $i++)
                @php
                    ...
                    if ( rand(1, 3) === 2 ) {
                        $user['badge'] = '<div class="symbol-badge bg-success start-100 top-100 border-4 h-8px w-8px ms-n2 mt-n2"></div>';
                    }
